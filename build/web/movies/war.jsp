        ...
        <section>
            <div class="containe">
                <div class="cover-profile">
                    ...
                    <div class="name">
                        <h1> War</h1><hr>
                        <p>An Indian soldier is assigned to eliminate his former mentor and he must keep his wits about him if he <br>
                            is to be successful in his mission. When the two men collide, it results in a barrage of battles and bullets.
</p>
                        <p><b>Release date:&nbsp</b>  2 October 2019(India)</p>
                        <p><b>Directors:&nbsp</b>  Siddharth Anand</p>
                        <p><b>Boxoffice Collection:&nbsp</b> 368 crore</p>
                        ...
                        <video width="1000" controls>
                            <source src="../video/War.mp4" type="video/mp4" >
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 segment-two">
                ...
                <ul>
                  ...
                  <li><a href="../loginabout.jsp">About Us</a></li>
                  <li><a href="../logincontact.jsp">Contact Us</a></li>
                  <li ><a href="../profile.jsp"> <b>Welcome</b> 
                    <%
